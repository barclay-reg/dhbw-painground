...
[![Build Status](https://travis-ci.org/barclay-reg/dhbw-painground.svg?branch=master)](https://travis-ci.org/barclay-reg/dhbw-painground) [![Build Status](https://sonarcloud.io/api/project_badges/measure?project=net.kleinschmager.dhbw.tfe16%3Apainground&metric=alert_status)](https://sonarcloud.io/dashboard?id=net.kleinschmager.dhbw.tfe16%3Apainground)
